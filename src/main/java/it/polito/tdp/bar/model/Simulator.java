...
public class Simulator {
	...
	private void creaTavoli() {
		...
		//devo associarli al tavolo più piccolo -> li ordino per dimensione dal più piccolo
	...
	private void creaEventi() {
		...
		for(int i = 0; i < this.NUM_EVENTI; i++) {
			//devo tirare a caso le seguenti variabili
			...
			this.queue.add(e);
			//faccio andare avanti il tempo secondo quanto detto nel testo (tra 1 e 10 minuti)
		...
		case ARRIVO_GRUPPO_CLIENTI:
			...
			if(tavolo != null) {
				...
				if(bancone <= e.getTolleranza()) {
					...
					System.out.println(e.getnPersone() +" persone se ne vanno a casa");
				}
			}
			break;
